						...
						<?php foreach ($pesanan as $psn) : ?>
							<div class="row">
								<div class="col d-flex align-items-center">
									<div class="item">
										<h7 style="margin-bottom: 20px;">Nomor : <?= $psn['no_pesanan']; ?> </h7>
					...
					<?php else : ?>
						<div class="row">
							<div class="col mb-3 mt-1">
								<?php echo form_open_multipart('pesanan/simpanorder'); ?>
								<div class="form-group">
									<select id="order" class="form-control" name="simpanorder">
										<option>- Pilih Jenis Order </option>
										<option><?php form_input('Reservation'); ?>Reservation</option>
										<option><?php form_input('Delivery'); ?>Delivery</option>
										<option><?php form_input('Take Away'); ?>Take Away</option>
									</select>
								</div>
								<a type="submit" href="<?= base_url('pesanan/bayar/') . $no_pesanan; ?>" id="bayar" class="btn btn-pesan text-uppercase" style="width: 100%;">Bayar</a>
							</div>
							<?php form_close(); ?>
						</div>
					<?php endif; ?>
